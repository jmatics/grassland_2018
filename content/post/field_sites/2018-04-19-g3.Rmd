...
setwd("D:/Data_Collection/2018/GIS_data/G3/")

mainplot <- readOGR(dsn = ".", layer = "g3_poly_epsg3044")
subplot <- readOGR(dsn = ".", layer = "g3_random_subplots")
center <- readOGR(dsn = ".", layer = "g3_random_points")
...
lab <- c(paste("g3_0", as.character(subplot@data$idn)[1:9], sep = ""), paste("g3_", as.character(subplot@data$idn[10:20]), sep = ""))
...
* Two cuts per year
* Located next to the river Werra
