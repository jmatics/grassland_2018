...
setwd("D:/Data_Collection/2018/GIS_data/G2/")

mainplot <- readOGR(dsn = ".", layer = "g2_poly_epsg3044")
subplot <- readOGR(dsn = ".", layer = "g2_random_subplots")
center <- readOGR(dsn = ".", layer = "g2_random_points")
...
lab <- c(paste("g2_0", as.character(subplot@data$id)[1:9], sep = ""), paste("g2_", as.character(subplot@data$id[10:20]), sep = ""))
